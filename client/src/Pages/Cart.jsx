            ...
            <div className="min-h-screen bg-brand-light flex items-center justify-center p-6">
                <Card className="max-w-[480px] w-full text-center p-12 shadow-2xl shadow-brand-orange/5 border-none">
                    ...
                    <p className="text-gray-500 font-medium mb-10 leading-relaxed">
                        Looks like you haven't added any delicacies yet. Explore our menu and start your heist!
                    </p>
                    <Button 
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 font-medium">You have {itemCount} items ready for heist.</p>
                    </div>
                </div>
                        ...
                        <Card className="p-8 border-none bg-white shadow-xl relative overflow-hidden">
                            ...
                            <div className="mb-10">
                                <div className="flex justify-between items-end mb-2">
                                    ...
                                    <span className="text-4xl font-black text-gray-900 tracking-tighter">{formatPrice(total)}</span>
                                </div>
